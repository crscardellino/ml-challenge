...
for usize in 1 0.95 0.9
do
    for epochs in 15 20
    do
        for char_dropout in 0.2 0.3
        do
            for pos_dropout in 0.2 0.3
            do
                ...
                do
                    ...
                    do
                        echo "Running for $language" >&2
                        python run_cnn_char_pos_emb.py \
                            $DATA_DIR \
                            $language \
                            $EXPERIMENTS_DIR \
                            --activation relu \
                            ...
                            --optimizer nadam \
                            --padding same \
                            --pos-tag-dropout $pos_dropout \
                            --pos-tag-vector-size 4 \
